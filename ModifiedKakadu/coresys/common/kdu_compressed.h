...
struct kdu_coords {
  ...
  */
  ...
  public: // Convenience functions
    ...
    kdu_coords plus(const kdu_coords &rhs)
    ...
    kdu_coords operator-(const kdu_coords &rhs)
      { kdu_coords result; result.x=x-rhs.x; result.y=y-rhs.y; return result; }
    kdu_coords minus(const kdu_coords &rhs)
      { /* [SYNOPSIS] Same as `operator-', but more suitable for
                      some language bindings. */
           return (*this)-rhs;
      }
    ...
    bool operator==(const kdu_coords &rhs)
      { return (x==rhs.x) && (y==rhs.y); }
    bool equals(const kdu_coords &rhs)
      { /* [SYNOPSIS] Same as `operator==', but more suitable for
                      some language bindings. */
           return (*this)==rhs;
      }
...
struct kdu_dims {
  ...
  public: // Convenience functions
    ...
    kdu_dims operator&(kdu_dims &rhs) // Intersects region with RHS.
      ...
      */
    kdu_dims intersection(kdu_dims &rhs)
    ...
    bool is_empty()
      ...
      */
    bool operator==(const kdu_dims &rhs)
      ...
      */
    bool equals(const kdu_dims &rhs)
  ...
  */
  public: // Member functions
    ...
    KDU_EXPORT const char *get_text();
      /* [SYNOPSIS]
           Returns the text string which is stored in the code-stream comment
           marker.   We currently support only ASCII text comments.  The
           returned string is null-terminated in the usual way and must not
           be overwritten.  The string may not be valid after a subsequent
           successful call to `check_readonly'.  The returned pointer will
           be NULL only if the interface has not been initialized.
      */
    KDU_EXPORT bool check_readonly();
      /* [SYNOPSIS]
           Returns true if any future call to `put_text' will fail.  This
           happens if the comment has been retrieved from or written as a
           code-stream comment marker segment already.
      */
    KDU_EXPORT bool put_text(const char *string);
      /* [SYNOPSIS]
           Returns false if the comment text has been frozen, as a result of
           writing it to or converting it from a code-stream comment marker
           segment.  Otherwise, appends the text in `string' to any existing
           text and returns true.
      */
  ...
  */
  ...
  public: // Member functions used to access information
    ...
    KDU_EXPORT int
      ...
      /* [SYNOPSIS]
           ...
           opened so far.  The function returns 1 (smallest number of
           allowable layers) if the no tiles have yet been opened.
      */
    KDU_EXPORT int
      get_min_dwt_levels();
      /* [SYNOPSIS]
           Returns the minimum number of DWT levels in any tile-component
           of any tile which has been opened so far.  This value is initially
           set to the number of DWT levels identified in the main header
           COD marker segment, but may decrease as tiles are opened.
      */
    KDU_EXPORT bool
  ...
  public: // Member functions used to modify behaviour
    ...
    KDU_EXPORT void
      ...
      */
	KDU_EXPORT void
		set_vt_params(int vt_nums, int Qmode, double *Qvalues, double *Rvalues,bool fastmode,double *VTvalues);

	KDU_EXPORT void
		set_map_fname(char *pfname, unsigned char *buffer, int height, int width,bool extralayer);
    ...
    KDU_EXPORT void
      ...
      /* [SYNOPSIS]
           ...
           [>>]   Secondly, it may be used to generate quality layers whose
                ...
                associated with an increase of delta_L in the byte count.  The
                offset, A, is selected to ensure that the entire range of
                slopes which could reasonably be encountered can fit into the
                range 0 to 2^16.  For the purpose of determining appropriate
  ...
  public: // Data processing/access member functions
    ...
    KDU_EXPORT kdu_long
      ...
      /* [SYNOPSIS]
           ...
           [//]
           The interpretation of the `precinct_idx' argument should lie within
           the range of indices returned via `get_valid_precincts'.
      */
    KDU_EXPORT kdu_node
      access_node();
      /* [SYNOPSIS]
