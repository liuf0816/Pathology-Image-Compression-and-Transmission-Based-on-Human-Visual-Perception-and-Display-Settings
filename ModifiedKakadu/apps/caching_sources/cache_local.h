...
struct kd_cache_hd {
  ...
  /* Notes:
     ...
     represent the number of missing bytes prior to the next segment and
     the number of bytes in the next segment, respectively. */
...
class kd_cache_buf_io {
  public: // Member functions
    ...
    void copy_from(kdu_byte data[], int num_bytes)
