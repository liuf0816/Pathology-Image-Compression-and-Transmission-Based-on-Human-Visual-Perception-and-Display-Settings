...
#define KDU_TIFFTAG_TileOffsets        ((kdu_uint32) 0x01440004)
...
struct kd_tifftag {
  private: // Member functions
     ...
     kd_tifftag()
       {
         tag_type=num_fields=bytes_per_field=num_bytes=read_ptr=max_bytes=0;
  ...
  private: // Data
     kdu_uint32 tag_type;
     kdu_uint32 num_fields;
     kdu_uint32 bytes_per_field; // Property of the `tag_type'
     kdu_uint32 num_bytes;
     union {
         kdu_long location; // If `num_bytes' > 4.
         kdu_byte data[4]; // If `num_bytes' <= 4.
       };
     kdu_uint32 read_ptr; // Byte offset into next byte to be read
     kdu_uint32 max_bytes; // Max entries in `out_buf'
...
class kdu_tiffdir {
  ...
  */
    public: // Member functions
      kdu_tiffdir()
        {
          is_open=littlendian=false; tags=NULL;
          int endian_test=1;
      ...
      bool operator!() { return !exists(); }
        /* [SYNOPSIS]
             Opposite of `exists'.
        */
      KDU_AUX_EXPORT void init(bool littlendian);
        /* [SYNOPSIS]
      ...
      KDU_AUX_EXPORT void close();
        ...
        */
      KDU_AUX_EXPORT kdu_uint32 get_dirlength();
        /* [SYNOPSIS]
        ...
        */
      KDU_AUX_EXPORT kdu_uint32 get_taglength(kdu_uint32 tag_type);
        /* [SYNOPSIS]
      ...
      KDU_AUX_EXPORT kdu_uint32 open_tag(kdu_uint32 tag_type);
         ...
         */
      KDU_AUX_EXPORT int
        read_tag(kdu_uint32 tag_type, int length, kdu_byte data[]);
        /* [SYNOPSIS]
             If the tag is not already open, `open_tag' is implicitly called
             first.  The function reads on from the last position read.
        ...
        */
      KDU_AUX_EXPORT int
        read_tag(kdu_uint32 tag_type, int length, kdu_uint16 data[]);
        /* [SYNOPSIS]
        ...
        */
      KDU_AUX_EXPORT int
        read_tag(kdu_uint32 tag_type, int length, kdu_uint32 data[]);
        /* [SYNOPSIS]
        ...
        */
      KDU_AUX_EXPORT int
        read_tag(kdu_uint32 tag_type, int length, double data[]);
        /* [SYNOPSIS]
             Same as the second form of `read_tag', except that this function
      ...
      void write_tag(kdu_uint32 tag_type, kdu_uint32 val32)
        ...
        /* [SYNOPSIS]
           ...
           the third form of the `write_tag' function for more info. */
      void write_tag(kdu_uint32 tag_type, double valdbl)
        ...
        /* [SYNOPSIS]
           ...
           See the second form of the `write_tag' function for more info. */
    ...
    private: // Helper functions
      ...
      void read_bytes(kdu_byte *buf, int num_bytes, kdu_long pos,
                      kdu_uint32 tag_type);
