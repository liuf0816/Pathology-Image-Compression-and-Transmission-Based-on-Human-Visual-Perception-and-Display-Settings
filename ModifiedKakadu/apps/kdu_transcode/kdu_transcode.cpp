  ...
  if (mem)
    {
      pretty_cout << "Total compressed data memory = "
                  << (long int) codestream_out.get_compressed_data_memory()
                  << " bytes.\n";
      pretty_cout << "Total state memory associated with compressed data = "
                  << (long int) (codestream_in.get_compressed_state_memory() +
  ...
  if (!quiet)
    {
      ...
      pretty_cout << "Total bytes read = "
                  << (long int) codestream_in.get_total_bytes()
                  << " = "
      ...
      pretty_cout << "Total bytes written = "
                  << (long int) codestream_out.get_total_bytes()
                  << " = "
