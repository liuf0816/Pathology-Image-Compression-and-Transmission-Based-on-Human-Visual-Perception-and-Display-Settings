  ...
  public: // Member functions
    ...
    bool operator!() { return !exists(); }
      /* [SYNOPSIS]
           Opposite of `exists'.
      */
    KDU_AUX_EXPORT void open(const char *fname, bool allow_seeks=true);
      /* [SYNOPSIS]
      ...
      */
    KDU_AUX_EXPORT void open(kdu_compressed_source *indirect);
      /* [SYNOPSIS]
      ...
      */
    KDU_AUX_EXPORT void open(kdu_cache *cache);
      /* [SYNOPSIS]
  ...
  public: // Navigation functions
    ...
    KDU_AUX_EXPORT bool is_complete();
      /* [SYNOPSIS]
           ...
           in the cache.  For this reason, you may only reliably invoke
           this function on a box which has no sub-boxes.
      */
    ...
    void reset_header_reading_state()
      {
        ...
        original_box_length = next_box_offset = 0;
        codestream_min = codestream_lim = codestream_id = -1;
      }
...
class jp2_family_tgt {
  ...
  */
  public: // Member functions
    jp2_family_tgt()
      { fp=NULL; indirect=NULL; last_write_pos=0; has_rubber_box=false; }
      /* [SYNOPSIS]
           You must use one of the `open' functions to create a legitimate
  ...
  public: // Member functions
    ...
    kdu_uint32 get_box_type() { return box_type; }
      /* [SYNOPSIS]
           ...
           This is also the condition which causes `exists' to return false. */
    const kdu_byte *get_contents(kdu_long &length)
      {
        if ((box_type == 0) || write_immediately || output_failed)
          { length = 0; return NULL; }
        length = (restore_size > 0)?restore_size:cur_size;
        return buffer;
      }
      /* [SYNOPSIS]
  ...
  public: // Access member functions
    ...
    KDU_AUX_EXPORT kdu_byte get_approximation_level();
      /* [SYNOPSIS]
           ...
           are:
           [>>] 0 -- nothing in particular is known about the approximation
                     level.  This value is to be used with JP2 files and may
                     also legally be used with JPX files.
