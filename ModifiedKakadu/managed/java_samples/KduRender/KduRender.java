...
/* END NOTE 2:
      ...
      converted to C++ integer exceptions with the value 0.  C++
      integer exceptions may also be thrown directly from inside
      Kakadu native objects.
          On the way back out, all C++ integer exceptions (including those
