...
public class Kdu_tiffdir {
  ...
  public native void Init(boolean _littlendian) throws KduException;
  ...
  public native int Read_tag(long _tag_type, int _length, byte[] _data) throws KduException;
  public native int Read_tag(long _tag_type, int _length, int[] _data) throws KduException;
  public native int Read_tag(long _tag_type, int _length, long[] _data) throws KduException;
  public native int Read_tag(long _tag_type, int _length, double[] _data) throws KduException;
  ...
  public native void Write_tag(long _tag_type, long _val32) throws KduException;
