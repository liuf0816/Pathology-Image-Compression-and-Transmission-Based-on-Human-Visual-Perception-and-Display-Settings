...
public class Kdu_analysis extends Kdu_push_ifc {
  ...
  private static native long Native_create(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, Kdu_roi_node _roi, Kdu_thread_env _env, long _env_queue);
  public Kdu_analysis(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, Kdu_roi_node _roi, Kdu_thread_env _env, long _env_queue) {
  ...
  private static long Native_create(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts)
  {
    ...
    return Native_create(_node,_allocator,_use_shorts,(float) 1.0F,roi,env,0);
  }
  ...
  private static long Native_create(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization)
  {
    Kdu_roi_node roi = null;
    Kdu_thread_env env = null;
    return Native_create(_node,_allocator,_use_shorts,_normalization,roi,env,0);
  }
  ...
  {
    Kdu_thread_env env = null;
    return Native_create(_node,_allocator,_use_shorts,_normalization,_roi,env,0);
  }
  ...
  {
    return Native_create(_node,_allocator,_use_shorts,_normalization,_roi,_env,0);
  }
  ...
  private static native long Native_create(Kdu_resolution _resolution, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, Kdu_roi_node _roi, Kdu_thread_env _env, long _env_queue);
  public Kdu_analysis(Kdu_resolution _resolution, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, Kdu_roi_node _roi, Kdu_thread_env _env, long _env_queue) {
  ...
  private static long Native_create(Kdu_resolution _resolution, Kdu_sample_allocator _allocator, boolean _use_shorts)
  {
    Kdu_roi_node roi = null;
    Kdu_thread_env env = null;
    return Native_create(_resolution,_allocator,_use_shorts,(float) 1.0,roi,env,0);
  }
  ...
  private static long Native_create(Kdu_resolution _resolution, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization)
  {
    Kdu_roi_node roi = null;
    Kdu_thread_env env = null;
    return Native_create(_resolution,_allocator,_use_shorts,_normalization,roi,env,0);
  }
  ...
  {
    Kdu_thread_env env = null;
    return Native_create(_resolution,_allocator,_use_shorts,_normalization,_roi,env,0);
  }
  ...
  {
    return Native_create(_resolution,_allocator,_use_shorts,_normalization,_roi,_env,0);
  }
